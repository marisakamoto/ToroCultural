        ...
        <div class="row principal mr-0">
            ...
            <div class="col-md-9 col-feed px-0 mx-0">
                ...
                <nav>
                    <div class="nav nav-tabs btn-principais-feed" id="nav-tab" role="tablist">
                        ...
                        @if(count($resultados) > 0)
                            <a class="btn-feed nav-item nav-link text-center" id="nav-home-tab" data-toggle="tab" href="#feed-user" role="tab" aria-controls="nav-home" aria-selected="true">Meu Feed</a>
                            <a class="btn-feed nav-item nav-link text-center active" id="nav-profile-tab" data-toggle="tab" href="#feed-site" role="tab" aria-controls="nav-profile" aria-selected="false">Pesquisa</a>
                        @else
                            <a class="btn-feed nav-item nav-link text-center active" id="nav-home-tab" data-toggle="tab" href="#feed-user" role="tab" aria-controls="nav-home" aria-selected="true">Meu Feed</a>
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    @if(count($resultados) > 0)
                        <div class="conteudo-feed tab-pane fade show px-2 py-2" id="feed-user" role="tabpanel" aria-labelledby="nav-home-tab">
                    ...
                    <div class="conteudo-feed tab-pane fade px-2 pt-2 active" id="feed-site" role="tabpanel" aria-labelledby="nav-profile-tab">
                        <div class="row justify-content-end">
                            <div class="text-secundario-feed pr-5 pb-2">
                                <label for="exampleFormControlSelect1">Organizar por:</label>
                                <select class="form-control" id="exampleFormControlSelect1">
